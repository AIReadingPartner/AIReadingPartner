...
exports.pageSummarize = async (req, res) => {
    try {
        ...
        const prompt = `Now I’m browsing a webpage with the text "${currentWebpage}" and I want to achieve "${browsingTarget}". If this is not a legal webpage to engage with, answer with "no"; If this is a legal webpage to engage with ,only provide me a summary of the webpage with less than 150 words.`;
